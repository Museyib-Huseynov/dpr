...
INSERT INTO `flowmeter` VALUES (1,11,'2025-01-06',92217,95299,93006,96088,'2024-10-01','2025-01-04 09:05:15');
...
CREATE TABLE `well_downtime_reasons` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_well_downtime_reason` (`well_id`,`report_date`),
...
-- Dump completed on 2025-01-04 14:25:43
